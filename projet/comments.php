...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   if(!isset($_SESSION["username"])){
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO commentaires(commentaire,idProduit,username) VALUES(?,?,?)";
        $insertion = $conn->prepare($sql);
            $insertion->execute([$comment, $id, $name]);
   ...
   <!--mid section-->
      <section class="mid_section">
        <div class="flex_box">
            <div class="left">
                <div class="big_img">
              <?php    echo  '<img class="imm" src="'.$pro["srcImage"].'"alt="">';    ?>
                </div>
            </div>
            <div class="right">
                <div class="pname">
                ...
                <div class="description"><?php echo $pro['description'] ?>.</div>
                <div class="price">$<?php echo $pro['prix'] ?></div>
                <div class="quantity">
                    <p>Quantity</p>
				...
				<a href="panier.php?idProduit='.$id.'?use='.$use.'"><button>pannier</button></a>
                </div>
                </form>'; 
				?>
            </div>
