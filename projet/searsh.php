<?php
 ...
 $searsh = $_POST['requete'];
 $req = "SELECT * FROM produits WHERE nomProduit LIKE '%$searsh%'"; 
 $res = $conn->query($req);
 $sear = $res->fetchAll();
  ?>
<!DOCTYPE html>
...
$cmt=0;
            ...
            foreach($sear as $ssear){
				
				if($cmt%3 == 0){echo'<tr><td>';
				echo '<div class="product_container">
             <div  class="product" Data-name="p-1">
			 <a href="details.php?idProduit='.$ssear["idProduit"].'">
			 <img class="imm" src="../aloha/'.$ssear["srcImage"].'"alt=""></a>
			 <div class="price">'.$ssear["prix"].'$</div>
			 <p class="product_name">'.$ssear["nomProduit"].' -></p>
			 </div>
